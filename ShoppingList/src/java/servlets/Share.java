...
public class Share extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(privileges >= Privileges.NOT_VERIFIED_USER_PRIVILEGES){
            int slid = ShoppingListQueries.getShoppingListByShareLink(conn, shareLink);
            
            if(slid > 0){
                ShoppingListQueries.insertSLMember(conn, slid, uid);
            } else {
                System.out.println("Invalid slid");
            }
        } else {
            System.out.println("User can't join sl");
        }
